...
export const PUZZLES: PuzzleDefinition[] = [
  ...
  },
  {
    ...
    name: 'Sacrifice Play',
    tier: 'apprentice',
    description: 'Last Words deals damage when your minion dies. Use it!',
    hint: 'Send your Last Words minion into the enemy minion so it dies.',
    playerHP: 3,
    playerCrystals: 0,
    playerRace: Race.PYROCLAST,
    playerBoard: [
      { name: 'Bomb Bot', attack: 1, health: 1, keywords: ['LAST_WORDS'], canAttack: true },
    ...
    solutionSteps: [
      'Attack Guard with Bomb Bot (dies, Last Words deals 2 to all enemies)',
      'Guard takes 1+2=3 damage (dies)',
      'Hero takes 2 Last Words damage',
      'Attack hero with Flame Warrior (4 + 1 remaining from guard death = not quite)',
      'Actually: Bomb Bot attacks Guard (1 damage), Bomb Bot dies, Last Words 2 to hero, Guard at 1 HP',
      'Wait — reassess. Bomb Bot (1 ATK) into Guard (3/2). Bomb Bot dies (Last Words 2 to hero=2). Guard at 1 HP.',
      'Flame Warrior attacks Guard (kills it). Hero at 2 HP but no more attacks...',
      'Hmm, let me fix: Last Words(3) instead.',
    ],
  },
  {
    id: 'p_a04',
