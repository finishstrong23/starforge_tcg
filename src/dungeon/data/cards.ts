...
const WARPRIDERS_CARDS: CardDefinition[] = [
  {
    ...
    upgradeText: 'Flux. A: Deal 6 damage. B: Deal 11 damage. C: Deal 8 damage and draw 1 card.',
  },
  {
    id: 'W-002', name: 'Warp Step', faction: 'WarpRiders', type: 'Skill', cost: 1,
    keywords: ['PHASE'], rarity: 'Common', complexityTier: 2,
    cardText: 'Flux. A: Gain 5 Block. B: Gain 4 Block and draw 1 card. C: Gain 7 Block.',
    upgradeText: 'Flux. A: Gain 7 Block. B: Gain 6 Block and draw 1 card. C: Gain 9 Block.',
  },
  {
    id: 'W-003', name: 'Twist', faction: 'WarpRiders', type: 'Skill', cost: 0,
    keywords: [], rarity: 'Common', complexityTier: 3,
    cardText: 'Draw 2 cards.',
    upgradeText: 'Draw 3 cards. Gain 1 Energy.',
  },
  {
  ...
  },
  {
    ...
    cardText: 'Gain 8 Block.',
    upgradeText: 'Gain 12 Block. Draw 1 card.',
  },
  {
  ...
  },
  {
    ...
    upgradeText: 'Flux. A: Deal 10 damage. B: Deal 4 damage twice. C: Deal 6 damage and draw 1 card.',
  },
  {
  ...
  },
  {
    ...
    keywords: [], rarity: 'Common', complexityTier: 1,
    cardText: 'Gain 6 Block. Draw 1 card.',
    upgradeText: 'Gain 8 Block. Draw 2 cards.',
  },
  {
    ...
    upgradeText: 'Flux. A: Deal 8 damage. B: Deal 10 damage. C: Deal 8 damage and apply Weak 2.',
  },
  {
  ...
  },
  {
    ...
    keywords: ['PHASE'], rarity: 'Common', complexityTier: 2,
    cardText: 'Flux. A: Gain 5 Block. B: Gain 8 Block. C: Gain 6 Block and draw 1 card.',
    upgradeText: 'Flux. A: Gain 8 Block. B: Gain 11 Block. C: Gain 8 Block and draw 1 card.',
  },
  {
  ...
  },
  {
    ...
    keywords: [], rarity: 'Uncommon', complexityTier: 3,
    cardText: 'Draw 1 card. Gain 6 Block.',
    upgradeText: 'Draw 2 cards. Gain 6 Block.',
  },
  {
    id: 'W-018', name: 'Event Horizon', faction: 'WarpRiders', type: 'Power', cost: 2,
    keywords: ['PHASE'], rarity: 'Uncommon', complexityTier: 2,
    cardText: 'At turn start, gain 4 Block.',
    upgradeText: 'At turn start, gain 5 Block. At turn start, gain 1 Energy.',
  },
  {
  ...
  },
  {
    ...
    cardText: 'Deal 20 damage. Exhaust.',
    upgradeText: 'Deal 28 damage. Exhaust.',
  },
  {
    id: 'W-023', name: 'Tesseract', faction: 'WarpRiders', type: 'Skill', cost: 2,
    keywords: ['PHASE'], rarity: 'Uncommon', complexityTier: 2,
    cardText: 'Gain 8 Block. Draw 2 cards.',
    upgradeText: 'Gain 12 Block. Draw 2 cards.',
  },
  {
    ...
    cardText: 'Flux. A: Gain 20 Block. B: Gain 14 Block and draw 1 card. C: Gain 18 Block.',
    upgradeText: 'Flux. A: Gain 25 Block. B: Gain 18 Block and draw 1 card. C: Gain 22 Block.',
  },
  {
    ...
    upgradeText: 'Flux. A: Deal 22 damage. B: Deal 14 damage and apply Vulnerable 3. C: Deal 14 damage twice.',
  },
  {
    id: 'W-026', name: 'Probability Reset', faction: 'WarpRiders', type: 'Skill', cost: 1,
    keywords: [], rarity: 'Uncommon', complexityTier: 2,
    cardText: 'Draw 3 cards.',
    upgradeText: 'Draw 4 cards. Gain 4 Block.',
  },
  {
    id: 'W-027', name: 'Entropy', faction: 'WarpRiders', type: 'Power', cost: 2,
    keywords: [], rarity: 'Uncommon', complexityTier: 2,
    cardText: 'At turn start, gain 4 Block.',
    upgradeText: 'At turn start, gain 6 Block. At turn start, draw 1 card.',
  },
  {
  ...
  },
  {
    ...
    keywords: ['PHASE'], rarity: 'Uncommon', complexityTier: 2,
    cardText: 'At turn start, draw 1 card.',
    upgradeText: 'At turn start, draw 1 card. At turn start, gain 1 Block.',
  },
  {
  ...
  },
  {
    ...
    cardText: 'Deal 22 damage. Apply Weak 2.',
    upgradeText: 'Deal 28 damage. Apply Weak 3.',
  },
  {
    id: 'W-032', name: 'Cosmic Choir', faction: 'WarpRiders', type: 'Power', cost: 3,
    keywords: ['PHASE'], rarity: 'Rare', complexityTier: 3,
    cardText: 'At turn start, deal 3 damage. At turn start, gain 1 Block.',
    upgradeText: 'At turn start, deal 5 damage. At turn start, gain 2 Block.',
  },
  {
    id: 'W-033', name: 'The Burning Face of the World', faction: 'WarpRiders', type: 'Attack', cost: 3,
    keywords: [], rarity: 'Rare', complexityTier: 3,
    cardText: 'Deal 40 damage to all enemies. Apply Vulnerable 2 to all enemies. Open 3 random Rifts for 2 turns. Exhaust.',
    upgradeText: 'Deal 55 damage to all enemies. Apply Vulnerable 3 to all enemies. Open 4 random Rifts for 2 turns. Exhaust.',
  },
  {
    id: 'W-034', name: 'Mistress of the Mysteries', faction: 'WarpRiders', type: 'Power', cost: 2,
    keywords: ['CLOAK'], rarity: 'Rare', complexityTier: 3,
    cardText: 'At turn start, draw 1 card.',
    upgradeText: 'At turn start, draw 1 card. At turn start, gain 1 Energy.',
  },
  {
    id: 'W-035', name: 'Omniverse Slash', faction: 'WarpRiders', type: 'Attack', cost: 3,
    keywords: ['BLITZ'], rarity: 'Rare', complexityTier: 3,
    cardText: 'Deal 8 damage 5 times.',
    upgradeText: 'Deal 10 damage 5 times.',
  },
  {
    id: 'W-036', name: 'Rift Master', faction: 'WarpRiders', type: 'Power', cost: 3,
    keywords: ['CLOAK'], rarity: 'Rare', complexityTier: 3,
    cardText: 'Open 2 random Rifts for 3 turns each.',
    upgradeText: 'Open 3 random Rifts for 3 turns each.',
  },
  {
    id: 'W-037', name: 'Schrödinger', faction: 'WarpRiders', type: 'Skill', cost: 2,
    keywords: ['PHASE'], rarity: 'Rare', complexityTier: 3,
    cardText: 'Deal 5 to 25 damage (random). Exhaust.',
    upgradeText: 'Deal 10 to 30 damage (random). Exhaust.',
  },
  {
    id: 'W-038', name: 'Chrono Break', faction: 'WarpRiders', type: 'Skill', cost: 3,
    keywords: ['PHASE'], rarity: 'Rare', complexityTier: 3,
    cardText: 'Draw 4 cards. Exhaust.',
    upgradeText: 'Draw 6 cards. Gain 1 Energy. Exhaust.',
  },
  {
    id: 'W-039', name: 'Reality Anchor', faction: 'WarpRiders', type: 'Power', cost: 2,
    keywords: ['PHASE'], rarity: 'Rare', complexityTier: 3,
    cardText: 'At turn start, gain 6 Block.',
    upgradeText: 'At turn start, gain 8 Block. At turn start, draw 1 card.',
  },
  {
    id: 'W-040', name: 'Genesis Bolt', faction: 'WarpRiders', type: 'Attack', cost: 3,
    keywords: ['BLITZ'], rarity: 'Rare', complexityTier: 3,
    cardText: 'Deal 25 damage to all enemies. Apply Weak 2 to all. Apply Vulnerable 2 to all. Apply 4 Burn to all. Open a Genesis Rift for 1 turn.',
    upgradeText: 'Deal 32 damage to all enemies. Apply Weak 3 to all. Apply Vulnerable 3 to all. Apply 5 Burn to all. Open a Genesis Rift for 1 turn.',
  },
  // ── Phase 1.5 additions: foundational vanilla cards ────────────────────────
