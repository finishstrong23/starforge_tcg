...
export const RELIC_POOL: RelicDefinition[] = [
  ...
  {
    id: 'R-S01', name: 'Forgeheart Ember', rarity: 'Common', trigger: 'combat_start', art: '🔥',
    description: 'Combat start: gain 2 Heat.',
    flavor: "The dying coal from your father's forge, still warm.",
  },
  {
    id: 'R-S02', name: 'Pattern Caliper', rarity: 'Common', trigger: 'passive', art: '📐',
  ...
  {
    id: 'R-S03', name: "Suncaller's Lens", rarity: 'Common', trigger: 'passive', art: '🔆',
    description: 'All Channel cards in hand have +1 Max Lumens.',
    flavor: 'Focuses the morning light through prayer.',
  },
  {
    id: 'R-S04', name: "Navigator's Bone", rarity: 'Common', trigger: 'combat_start', art: '🦴',
  ...
  // ─── Uncommon Relics (5) ──────────────────────────────────────────────────
  {
    id: 'R-U01', name: "Forgemaster's Sigil", rarity: 'Uncommon', trigger: 'combat_start', art: '⚙️',
  ...
  {
    id: 'R-U02', name: "Starseer's Pendant", rarity: 'Uncommon', trigger: 'turn_end', art: '⭐',
    description: 'Whenever you retain a card between turns, gain 1 Block.',
    flavor: 'Crystallized starlight. Warm to the touch.',
  },
  {
    id: 'R-U03', name: 'Void Compass', rarity: 'Uncommon', trigger: 'combat_start', art: '🧭',
  ...
  {
    id: 'R-U04', name: 'Overclocked Core', rarity: 'Uncommon', trigger: 'combat_start', art: '🔋',
  ...
  {
    id: 'R-U05', name: "Cursebreaker's Medallion", rarity: 'Uncommon', trigger: 'combat_start', art: '🎗️',
  ...
  // ─── Rare Relics (5) ──────────────────────────────────────────────────────
  {
    id: 'R-R01', name: 'Crown of the Unburnt', rarity: 'Rare', trigger: 'passive', art: '👑',
  ...
  {
    id: 'R-R05', name: "Runekeeper's Tome", rarity: 'Rare', trigger: 'combat_start', art: '📖',
  ...
  // ─── Boss Relics (3) ──────────────────────────────────────────────────────
  {
    id: 'R-B01', name: "The Hierophant's Censer", rarity: 'Boss', trigger: 'combat_start', art: '🕯️',
  ...
  {
    id: 'R-B02', name: 'Spire-Glass Lens', rarity: 'Boss', trigger: 'on_kill', art: '🔍',
    description: 'Killing an enemy: +1 Max HP. Taking HP damage: cannot heal this combat.',
    flavor: 'Cracked but functional.',
  },
  {
    id: 'R-B03', name: 'Heartwake Echo', rarity: 'Boss', trigger: 'combat_start', art: '💔',
  ...
  // ─── Anomaly Relic (1) ────────────────────────────────────────────────────
  {
    id: 'R-A01', name: 'Shard of the Choir', rarity: 'Rare', trigger: 'on_card_play', art: '🎵',
